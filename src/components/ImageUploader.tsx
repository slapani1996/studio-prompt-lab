...
interface ImageUploaderProps {
  ...
  existingImages?: Array<{ id: string; path: string; filename: string }>;
  onRemoveExisting?: (id: string) => void;
}

export default function ImageUploader({ onImagesChange, existingImages = [], onRemoveExisting }: ImageUploaderProps) {
